                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="signup" method="post" class="user">
                                ...
                                <div class="form-group">
                                    <input name="phone" type="phone" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="Phone Number">
                                </div>
                                <div class="form-group">
                                    <input name="username" type="username" class="form-control form-control-user" id="exampleInputEmail"
